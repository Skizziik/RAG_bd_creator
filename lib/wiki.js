...
function extractFromHTML(html, fallbackTitle) {
  ...
  // Remove noise
  $('script, style, nav, footer, header, .sidebar, .infobox, .navbox, .portable-infobox, .pi-item, .mw-editsection, .reference, .reflist, #mw-navigation, .noprint, .toc, .catlinks, .mw-indicators, .vector-body-before-content').remove();
