...
function extractFromHTML(html, fallbackTitle) {
  ...
  $('h2, h3').each((_, el) => {
    ...
    if (['history', 'changelog', 'references', 'external links', 'see also', 'gallery', 'trivia', 'crafting', 'recipes', 'achievements', 'tips', 'set', 'notes', 'bugs', 'effects', 'synergies'].includes(heading)) {
